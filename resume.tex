...
\begin{tabular}{|p{\dimexpr.19\textwidth} |>{\centering\arraybackslash} p{\dimexpr.33\textwidth-3\tabcolsep} |p{\dimexpr.19\textwidth-3\tabcolsep} |
	...
	\hline
	\centering Final Year &  \multirow{3}{*}{ \specialcell{Walchand College \\ Of Engineering, Sangli}} & \centering Pursuing & \centering - & 2015-16\\
	\cline{1-1}\cline{3-5}
...
\hline 
	...
	A Technical Forum  & Ease to solve technical Queries of students &
	\begin{itemize}	
